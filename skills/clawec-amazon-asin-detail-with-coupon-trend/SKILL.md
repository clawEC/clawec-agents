---
name: clawec-amazon-asin-detail-with-coupon-trend
description: 通过 clawEC API 查询亚马逊 ASIN 详情及优惠券/促销价格趋势。在用户需要 ASIN 优惠趋势、促销价格变化时使用。
---
...
本技能调用 clawEC 开放 API，用于查询 ASIN 详情及历史优惠券/促销价格变化趋势。
...
`POST /aigc/ec/amazon/data/asin/detail_with_coupon_trend`
...
```bash
curl -s -X POST "https://www.clawec.com/api/aigc/ec/amazon/data/asin/detail_with_coupon_trend" \
