---
name: clawec-tiktok-market-category-ranking
description: 通过 clawEC API Tiktok一级类目销量榜 查询市场一级类目销量排名、增速与头部集中度。在用户需要 Tiktok一级类目销量榜、TikTok 相关数据查询时使用。
---
...
本技能调用 clawEC 开放 API，用于Tiktok一级类目销量榜 查询市场一级类目销量排名、增速与头部集中度。
...
`POST /aigc/ec/tiktok/data/market/category_ranking`
