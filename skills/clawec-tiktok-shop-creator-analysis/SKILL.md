---
name: clawec-tiktok-shop-creator-analysis
description: 通过 clawEC API Tiktok店铺达人分析 查询店铺合作达人、粉丝层级分布、短视频/直播带货结构。在用户需要 Tiktok店铺达人分析、TikTok 相关数据查询时使用。
---
...
本技能调用 clawEC 开放 API，用于Tiktok店铺达人分析 查询店铺合作达人、粉丝层级分布、短视频/直播带货结构。
...
`POST /aigc/ec/tiktok/data/shop/creator_analysis`
...
```bash
curl -s -X POST "https://www.clawec.com/api/aigc/ec/tiktok/data/shop/creator_analysis" \
