---
name: clawec-tiktok-creator-search
description: 通过 clawEC API Tiktok达人搜索 按昵称/关键词/垂类/粉丝画像搜索达人。在用户需要 Tiktok达人搜索、TikTok 相关数据查询时使用。
---
...
本技能调用 clawEC 开放 API，用于Tiktok达人搜索 按昵称/关键词/垂类/粉丝画像搜索达人。
...
`POST /aigc/ec/tiktok/data/creator/search`
...
```bash
curl -s -X POST "https://www.clawec.com/api/aigc/ec/tiktok/data/creator/search" \
