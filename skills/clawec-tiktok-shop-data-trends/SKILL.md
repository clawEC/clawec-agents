---
name: clawec-tiktok-shop-data-trends
description: 通过 clawEC API Tiktok店铺数据趋势 查询店铺销量/GMV/达人数/直播数/视频数/在售商品数等日趋势。在用户需要 Tiktok店铺数据趋势、TikTok 相关数据查询时使用。
---
...
本技能调用 clawEC 开放 API，用于Tiktok店铺数据趋势 查询店铺销量/GMV/达人数/直播数/视频数/在售商品数等日趋势。
...
`POST /aigc/ec/tiktok/data/shop/data_trends`
...
```bash
curl -s -X POST "https://www.clawec.com/api/aigc/ec/tiktok/data/shop/data_trends" \
