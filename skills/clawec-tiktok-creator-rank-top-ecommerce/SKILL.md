---
name: clawec-tiktok-creator-rank-top-ecommerce
description: 通过 clawEC API Tiktok电商达人榜  按电商 GMV 等指标查询头部带货达人榜。在用户需要 Tiktok电商达人榜、TikTok 相关数据查询时使用。
---
...
本技能调用 clawEC 开放 API，用于Tiktok电商达人榜  按电商 GMV 等指标查询头部带货达人榜。
...
`POST /aigc/ec/tiktok/data/creator/rank/top_ecommerce`
...
| author_product_type | body | 否 | 带货模式：1=短视频带货，2=直播带货 |
