---
name: clawec-tiktok-product-rank-top-selling
description: 通过 clawEC API Tiktok热销商品榜 查询市场/类目热销商品榜，含 GMV、销量、增长率、价格、店铺等。在用户需要 Tiktok热销商品榜、TikTok 相关数据查询时使用。
---
...
本技能调用 clawEC 开放 API，用于Tiktok热销商品榜 查询市场/类目热销商品榜，含 GMV、销量、增长率、价格、店铺等。
...
`POST /aigc/ec/tiktok/data/product/rank/top_selling`
