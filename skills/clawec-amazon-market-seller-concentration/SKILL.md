---
name: clawec-amazon-market-seller-concentration
description: 通过 clawEC API 查询亚马逊类目头部卖家集中度。在用户需要卖家集中度、类目竞争格局分析时使用。
---
...
本技能调用 clawEC 开放 API，用于查询指定类目下头部卖家的市场份额与竞争态势。
...
`POST /aigc/ec/amazon/data/market/seller_concentration`
