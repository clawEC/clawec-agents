---
name: clawec-shopee-brand-price-distribute
description: 通过 clawEC API 查询 Shopee 品牌商品价格区间分布。在用户需要 Shopee品牌价格分布、Shopee 相关数据查询时使用。
---
...
本技能调用 clawEC 开放 API，用于查询 Shopee 品牌商品价格区间分布。
...
`POST /aigc/ec/shopee/data/brand/price/distribute`
