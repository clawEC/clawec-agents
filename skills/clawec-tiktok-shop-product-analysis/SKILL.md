---
name: clawec-tiktok-shop-product-analysis
description: 通过 clawEC API Tiktok店铺商品分析 查询店铺主推类目、价格带、爆品/新品/潜力品分布及商品明细。在用户需要 Tiktok店铺商品分析、TikTok 相关数据查询时使用。
---
...
本技能调用 clawEC 开放 API，用于Tiktok店铺商品分析 查询店铺主推类目、价格带、爆品/新品/潜力品分布及商品明细。
...
`POST /aigc/ec/tiktok/data/shop/product_analysis`
...
```bash
curl -s -X POST "https://www.clawec.com/api/aigc/ec/tiktok/data/shop/product_analysis" \
