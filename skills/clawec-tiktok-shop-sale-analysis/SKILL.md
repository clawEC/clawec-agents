---
name: clawec-tiktok-shop-sale-analysis
description: 通过 clawEC API Tiktok店铺成交结构 查询店铺短视频/直播/商品卡等渠道与内容形式分布。在用户需要 Tiktok店铺成交结构、TikTok 相关数据查询时使用。
---
...
本技能调用 clawEC 开放 API，用于Tiktok店铺成交结构 查询店铺短视频/直播/商品卡等渠道与内容形式分布。
...
`POST /aigc/ec/tiktok/data/shop/sale_analysis`
...
```bash
curl -s -X POST "https://www.clawec.com/api/aigc/ec/tiktok/data/shop/sale_analysis" \
