---
name: clawec-amazon-asin-sales-trend
description: 通过 clawEC API 查询亚马逊 ASIN 父/子体销量与销售额历史趋势。在用户需要销量趋势、销额历史走势时使用。
---
...
本技能调用 clawEC 开放 API，用于查询 ASIN 父体/子体月销量与销售额历史趋势。
...
`POST /aigc/ec/amazon/data/asin/sales_trend`
