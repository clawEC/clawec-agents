---
name: clawec-tiktok-live-detail
description: 通过 clawEC API Tiktok直播详情分析 查询单场直播基础信息、核心表现、带货策略与商品结构。在用户需要 Tiktok直播详情分析、TikTok 相关数据查询时使用。
---
...
本技能调用 clawEC 开放 API，用于Tiktok直播详情分析 查询单场直播基础信息、核心表现、带货策略与商品结构。
...
`POST /aigc/ec/tiktok/data/live/detail`
