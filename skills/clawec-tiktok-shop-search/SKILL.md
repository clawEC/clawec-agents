---
name: clawec-tiktok-shop-search
description: 通过 clawEC API Tiktok店铺搜索 按店铺名/关键词/地区搜索店铺。在用户需要 Tiktok店铺搜索、TikTok 相关数据查询时使用。
---
...
本技能调用 clawEC 开放 API，用于Tiktok店铺搜索 按店铺名/关键词/地区搜索店铺。
...
`POST /aigc/ec/tiktok/data/shop/search`
...
```bash
curl -s -X POST "https://www.clawec.com/api/aigc/ec/tiktok/data/shop/search" \
